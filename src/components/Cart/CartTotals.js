        ...
        <div className='container'>
            <div className="row">
                <div className="col-10 mt-2 ml-sm-5 ml-md-auto col-sm-8">
                    <Link to="/">
                        <button onClick={()=>clearCart()} className="btn btn-danger mb-3 px-5">Clear Cart</button> 
                    </Link>
                    <h5><span className="text-title">Sub Total: </span><strong>${cartSubTotal}</strong></h5>
